...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            if score0 < goal and not extra_turn(score0, score1):
                who = other(who)
        elif who == 1:
            score1 += take_turn(strategy1(score1, score0), score0, dice)
            say = say(score0, score1)
            if score1 < goal and not extra_turn(score1, score0):
                who = other(who)
    # END PROBLEM 5
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    #announce_leaded_changes(last_leader = None)
    "*** YOUR CODE HERE ***"
    def say(score0, score1):
        if who == 0:
            roundScore0 = score0 - last_score
            if roundScore0 > running_high:
                print(score0, "point(s)! The most yet for Player", who)
                return announce_highest(who, score0, roundScore0)
            else:
                return announce_highest(who, score0, running_high)
        elif who == 1:
            roundScore1 = score1 - last_score
            if roundScore1 > running_high:
                print(roundScore1, "point(s)! The most yet for Player", who)
                return announce_highest(who, score1, roundScore1)
            else:
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    avgScore = make_averaged(roll_dice, trials_count)
    numDice, maxDice, maxScore = 1, 1, 0
    while numDice <= 10:
        score = avgScore(numDice, dice)
        if maxScore < score:
            maxScore = score
            maxDice = numDice
        numDice += 1
