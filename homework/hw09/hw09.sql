...
CREATE TABLE sentences AS
  SELECT "The two siblings, " || sib1 || " plus " || sib2 || " have the same size: " || a.size FROM siblings, size_of_dogs as a, size_of_dogs as b WHERE a.name = sib1 AND b.name = sib2 AND a.size = b.size;
